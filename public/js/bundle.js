  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://127.0.0.1:3001/api/v1/users/updateMyPassword' : 'http://127.0.0.1:3001/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51P4vxPJNCKK59bZfdm5iM3zMLlMCjCL47NPQwDubxbm2Z1rhHyd3O0IlLabESKiSMTbzWyrXc1xDMRZ7coXUbWdz006SJVwtwG');
          _context.prev = 1;
          _context.next = 4;
